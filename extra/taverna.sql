...
-- -----------------------------------------------------
-- Table `taverna`.`interesses_usuarios`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `taverna`.`interesses_usuarios` ;

CREATE TABLE IF NOT EXISTS `taverna`.`interesses_usuarios` (
