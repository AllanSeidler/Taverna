...
-- -----------------------------------------------------
-- Data for table `taverna`.`interesse`
-- -----------------------------------------------------
START TRANSACTION;
USE `taverna`;
INSERT INTO `taverna`.`interesse` (`id`, `interesse`) VALUES (DEFAULT, 'Magic: The Gathering');
INSERT INTO `taverna`.`interesse` (`id`, `interesse`) VALUES (DEFAULT, 'Yu-Gi-Oh!');
INSERT INTO `taverna`.`interesse` (`id`, `interesse`) VALUES (DEFAULT, 'Pokémon TCG');
