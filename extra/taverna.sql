...
-- -----------------------------------------------------
-- Table `taverna`.`usuarios`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `taverna`.`usuarios` ;

CREATE TABLE IF NOT EXISTS `taverna`.`usuarios` (
...
-- -----------------------------------------------------
-- Table `taverna`.`interesses`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `taverna`.`interesses` ;

CREATE TABLE IF NOT EXISTS `taverna`.`interesses` (
...
-- -----------------------------------------------------
-- Table `taverna`.`amizades`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `taverna`.`amizades` ;

CREATE TABLE IF NOT EXISTS `taverna`.`amizades` (
  ...
  CONSTRAINT `fk_usuario1`
    ...
    REFERENCES `taverna`.`usuarios` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE INDEX `fk_usuario2_idx` ON `taverna`.`amizades` (`id_usuario2` ASC) VISIBLE;


-- -----------------------------------------------------
-- Table `taverna`.`eventos`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `taverna`.`eventos` ;

CREATE TABLE IF NOT EXISTS `taverna`.`eventos` (
  ...
  CONSTRAINT `fk_jogo`
    FOREIGN KEY (`id_jogo`)
    REFERENCES `taverna`.`interesses` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;

CREATE INDEX `fk_jogo_idx` ON `taverna`.`eventos` (`id_jogo` ASC) VISIBLE;


-- -----------------------------------------------------
-- Table `taverna`.`mensagens`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `taverna`.`mensagens` ;

CREATE TABLE IF NOT EXISTS `taverna`.`mensagens` (
...
CREATE INDEX `fk_destinatario_idx` ON `taverna`.`mensagens` (`id_destinatario` ASC) VISIBLE;
